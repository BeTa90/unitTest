...
module.exports = function (grunt) {
	...
	var targetDir = "dist";
	var preloadPrefix = "opademo";
	var namespace = "opademo";
	...
	var config = {
		...
		karma: {
			options: {
				...
				openui5: {
					//path: "https://webidecp-s0019012780trial.dispatcher.hanatrial.ondemand.com/B.Muslu/unittest.git" // eslint-disable-line
					//path: "https://webidecp-s0019012780trial.dispatcher.hanatrial.ondemand.com/sap/public/bc/ui5_ui5/1/resources/sap-ui-core.js"
					//path: "https://https://extern.realcore.de:8200/B.Muslu/unittest.git" // eslint-disable-line
				    path: "https://sapui5.hana.ondemand.com/1.60.25/resources/sap-ui-core.js" // eslint-disable-line
